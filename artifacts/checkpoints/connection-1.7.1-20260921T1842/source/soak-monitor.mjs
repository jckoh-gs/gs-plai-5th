import {createSoakDiagnostics} from './soak-diagnostics.mjs';
...
let messages=0,duplicates=0,invalid=0,maxPayloadBytes=0,connectionErrors=0,apiErrors=0,polls=0,lastMessageAt=null,stopping=false;
const diagnostics=createSoakDiagnostics();
