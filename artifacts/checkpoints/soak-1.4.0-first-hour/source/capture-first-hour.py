...
root=Path.cwd();out=root/'artifacts/checkpoints/soak-1.4.0-first-hour'
...
primary=prefix('artifacts/soak/v1.4.0/observations.jsonl')
audit_dir=Path('artifacts/soak/telemetry-audit/2026-09-21T13-49-42-893Z-9fe9c0ec')
...
assert run['deployment']['productVersion']=='1.4.0'
...
for directory in [Path('artifacts/soak/v1.4.0/source'),audit_dir/'source']:
