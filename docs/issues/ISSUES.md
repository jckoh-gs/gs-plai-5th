...
- 중요도 P2. 상태 OPEN(1.4.0 후보 구현 대기), 담당 메인/UI, IDEA-008 채택 개정3 / PRD1.11에 연결.
...
- 첫1시간1.3 관찰 후 PRD1.11/제품1.4.0 후보로 채택했다. 소스 수정·회귀·배포 검증 전이며 아직 해결 처리하지 않는다. Date가 유효해도 서버 네 자리 ISO 형식과 다른 확장 연도는 제출 전 안내한다.
