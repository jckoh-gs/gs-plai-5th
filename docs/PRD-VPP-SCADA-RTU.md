...
현재 기능상 안정 기준: **1.4.0 / IDEA-008 개정3**. 신규 채택 후보는 **1.5.0 / IDEA-009 / PRD1.12**이며 구현·검증 전이다. 일반 목표 입력 범위 안내와 ISSUE-021 만료일 처리를 구현하고 실제 k3s·MQTT·재시작·동일 백업의1.4 및 하위1.3 복원을 검증했다. REVIEW-021과 인수 추적이 근거다. runtime `fdd0491a5c08901962f46ac845f8582921150d45`, 이미지 `c19d550f…b4f4`를 안정 기준으로 고정한다. 태그·immutable manifest 검증은 운영 기록에서 별도로 확인한다. 이전1.3 checkpoint는 복원 이력으로 보존하며 원래 동결·마감과 최종 영상/PPT 조건은 유지한다.
