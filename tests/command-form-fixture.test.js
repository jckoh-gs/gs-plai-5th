...
test('unreviewed product or target modes fail closed',()=>{
 for(const version of ['1.5.1','1.5.0-rc.1','1.6.1','1.7.1','1.8.0'])assert.throws(()=>fixtureConfig({GRID_CANDIDATE_VERSION:version,EXPECTED_BUNDLE_SHA256:hash}),/Unreviewed/);
